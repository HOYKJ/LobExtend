 ...
 * @author hoykj
 */
public class MeltingLoveSmallSlime extends AbstractFriendlyMonster {
    public static final String ID = "MeltingLoveSmallSlime";
    ...
    public MeltingLoveSmallSlime(float x, float y) {
        super(NAME, "MeltingLoveSmallSlime", 20, 0.0F, -4.0F, 180.0F, 120.0F, null, x, y);
