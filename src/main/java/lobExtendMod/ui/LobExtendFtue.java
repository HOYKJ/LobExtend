 ...
 * @author hoykj
 */
public class LobExtendFtue extends FtueTip {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString("LobotomyExtendTutorial");
    ...
    public LobExtendFtue() {
        this.img1 = ImageMaster.loadImage("lobExtendMod/images/ui/tip/t1.png");
        this.img2 = ImageMaster.loadImage("lobExtendMod/images/ui/tip/t1.png");
        this.img3 = ImageMaster.loadImage("lobExtendMod/images/ui/tip/t1.png");
        msg1 = MSG[0];
        msg2 = MSG[1];
        msg3 = MSG[2];
        this.closeScreen = -2;
