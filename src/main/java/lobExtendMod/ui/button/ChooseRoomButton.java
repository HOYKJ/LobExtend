 ...
 * @author hoykj
 */
public class ChooseRoomButton {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("ChooseRoomButton");
    public static final String[] TEXT = uiStrings.TEXT;
    private static final Color HOVER_BLEND_COLOR = new Color(1.0F, 1.0F, 1.0F, 0.4F);
    private static final float SHOW_X = 1300.0F * Settings.scale, DRAW_Y = 860.0F * Settings.scale;
    ...
    public ChooseRoomButton(LobotomyEvent root) {
    ...
    public void render(SpriteBatch sb) {
        ...
        if (this.hb.clicked) {
            ...
            LobExtendMod.chooseRoomScreen = new ChooseRoomScreen(this.root);
        }
        if (!this.isHidden)
            this.hb.render(sb);
    }
