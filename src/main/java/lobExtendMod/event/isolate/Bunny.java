...
import lobExtendMod.npc.event.BunnyNpc;

/**
 * @author hoykj
 */
public class Bunny extends AbstractIsolate {
    public static final String ID = "Bunny";
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString("Bunny");
    ...
    public Bunny(LobotomyEvent root){
        this.root = root;
        this.title = NAME;
        this.npc = new AnimateEventNpc(Settings.WIDTH * 0.75F, AbstractDungeon.floorY,
                "lobExtendMod/images/monsters/Bunny/Bunny_Room.atlas", "lobExtendMod/images/monsters/Bunny/Bunny_Room.json",
                "Default", 1.0F);
        ...
        switch (this.screen) {
            case INTRO:
                if (buttonPressed == 0) {
                    ...
                    this.root.addNpc(new BunnyNpc(this.root.getRandomIsolate()));
    ...
    public Texture getImg() {
        if (this.entered) {
            return LobExtendImageMaster.BUNNY;
        }
        else {
